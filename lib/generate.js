...
function generateComponent(type, module, componentName, answers, answersInner, cb) {
	try {
...
const createComponent = function(module, componentName, answers, answersInner, cb) {
	generateComponent(answers.componentType, module, componentName, answers, answersInner, cb);
}
...
const createTest = function(module, testName, cb) {
	try {
